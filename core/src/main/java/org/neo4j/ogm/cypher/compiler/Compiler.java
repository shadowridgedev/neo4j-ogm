...
public interface Compiler {
     ...
     * @param bidirectional true if the relationship must be created in both incoming and outgoing directions, false
     * otherwise
     *
    ...
    /**
     * Returns a {@link NodeBuilder} that represents a node that already exists in the database and matches the given
     * ID.
     *
    ...
    /**
     * Returns a {@link RelationshipBuilder} that represents and existing relationship entity to be modified in the
     * database
     *
    ...
    /**
     * Defines a relationship deletion between the specified start node to end node with the given relationship type and
     * direction.
     *
     ...
     * after all query building has been completed and to be aware that some statements may depend upon results of
     * previous statements
     * </p>
     *
     * @return A {@link List} of Cypher queries to be executed or an empty list if there aren't any, never <code>null</code>
