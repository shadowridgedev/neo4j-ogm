...
public interface EntityMapper {
    ...
    /**
     * Processes the given object and any of its composite persistent objects and produces Cypher queries to persist
     * their state
     * in Neo4j.
     *
     * @param entity The "root" node of the object graph to persist
     *
     * @return A {@link org.neo4j.ogm.cypher.compiler.CompileContext} object containing the statements required to
     * persist the given object to Neo4j, along
    ...
    /**
     * Processes the given object and any of its composite persistent objects to the specified depth and produces Cypher
     * queries
